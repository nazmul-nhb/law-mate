...
const en = {
	translation: {
		...
		'legal.privacy.contact.body':
			'If you have any questions about this Privacy Policy, please contact us via the project repository on GitHub (https://github.com/nazmul-nhb/law-mate/) or this URL (https://nazmul-nhb.vercel.app/)',
		...
		'settings.data.export.desc': 'Backup your data to a JSON file.',
		'settings.data.export.laws': 'Include Laws',
		'settings.data.export.notes': 'Include Notes',
		...
		'settings.data.import.dropzone': 'Drag & drop JSON file here or click to select',
		'settings.data.import.preview': 'Import Preview',
		'settings.data.import.confirm': 'Are you sure you want to proceed with the import?',
		'settings.data.import.success': 'Data imported successfully',
		'settings.data.import.error.invalid': 'Invalid JSON file format.',
		'settings.data.import.error.empty': 'No importable data found in the file.',
		'settings.data.import.changes.insert': 'Data to insert',
		'settings.data.import.changes.update': 'Data to update',
		'settings.data.import.changes.skip': 'Data to skip',
		'settings.data.import.changes.delete': 'Data to delete',
		'settings.data.import.run': 'Confirm Import',

		// DB Explorer
		'settings.data.explore.label': 'IndexedDB Explorer',
		'settings.data.explore.desc': 'Explore all local data saved in your browser.',
		...
		'settings.data.explore.confirm.delete':
			'Are you sure you want to delete the selected data permanently?',
		'settings.data.explore.confirm.delete.single':
			'Are you sure you want to delete this item permanently?',
		'settings.data.explore.delete.single': 'Delete Item',
		'settings.data.explore.col.id': 'ID',
		'settings.data.explore.col.title': 'Title',
		'settings.data.explore.col.owner': 'Owner ID',
		'settings.data.explore.col.status': 'Status',
		'settings.data.explore.col.version': 'Version',
	},
};

...
const en = {
	translation: {
		...
		'settings.data.import.error.empty': 'No importable note data found in file.',
		'settings.data.import.changes.insert': 'Notes to insert',
		'settings.data.import.changes.update': 'Notes to update',
		'settings.data.import.changes.skip': 'Notes to skip',
		'settings.data.import.changes.delete': 'Notes to delete',

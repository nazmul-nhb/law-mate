...
const bn = {
	translation: {
		...
		'editor.ocr.error.no_text': 'ছবিতে পড়ার মতো কোনো লেখা পাওয়া যায়নি।',
		...
		'legal.privacy.contact.body':
			'এই গোপনীয়তা নীতি সম্পর্কে কোনো প্রশ্ন থাকলে, অনুগ্রহ করে GitHub রিপোজিটরি (https://github.com/nazmul-nhb/law-mate/) অথবা এই URL-এর (https://nazmul-nhb.vercel.app/) মাধ্যমে আমাদের সাথে যোগাযোগ করুন।',
		...
		'settings.data.export.desc': 'একটি JSON ফাইলে আপনার ডেটা ব্যাকআপ রাখুন।',
		'settings.data.export.laws': 'আইন অন্তর্ভুক্ত করুন',
		'settings.data.export.notes': 'নোট অন্তর্ভুক্ত করুন',
		...
		'settings.data.import.desc': 'পূর্বে এক্সপোর্ট করা কোনো JSON ফাইল থেকে পুনরুদ্ধার করুন।',
		...
		'settings.data.import.error.empty': 'ফাইলে কোনো ইম্পোর্টযোগ্য ডেটা পাওয়া যায়নি।',
		...
		'settings.data.explore.desc': 'আপনার ব্রাউজারে সংরক্ষিত সমস্ত লোকাল ডেটা দেখুন।',
		...
		'settings.data.explore.confirm.clear':
			'আপনি কি IndexedDB এর সমস্ত ডেটা মুছে ফেলতে চান? এটি স্থায়ীভাবে মুছে যাবে।',
		'settings.data.explore.confirm.delete': 'আপনি কি নির্বাচিত ডেটা চিরস্থায়ীভাবে মুছে ফেলতে চান?',
		'settings.data.explore.confirm.delete.single':
			'আপনি কি এই ডেটা চিরস্থায়ীভাবে মুছে ফেলতে চান?',
		'settings.data.explore.delete.single': 'ডেটা মুছুন',
